...
import homeBackground from '../assets/images/background3.jpg'; // 이미지 import

function ServicesSectionSection() {
    ...
    return (
        <section id="services" ref={sectionRef} style={{ ...sectionStyle, backgroundImage: `url(${homeBackground})` }}>
            {/* 애니메이션 정의 */}
            <style>
                {`
                    @keyframes fadeIn {
...
export default ServicesSectionSection;
